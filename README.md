...
본 문서는 Codex가 연구용 소프트웨어 저장소를 생성하고, IEEE 30-bus 송전계통과 IEEE 123-node 배전계통에서 데이터 생성·특징량 추출·이벤트 분류·고장 위치 식별·WMU 배치 최적화·강건성 검증·논문용 결과 생성을 재현 가능하게 수행하도록 정의하는 제품 요구사항 문서다.
